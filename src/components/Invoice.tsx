    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-panel-dark p-6 rounded-md flex flex-col md:flex-row md:items-center md:justify-between">
        ...
        <div className="mt-4 md:mt-0 flex gap-2">
          <button onClick={handleEdit} className="bg-muted text-sm px-4 py-2 rounded-md text-foreground hover:opacity-90">Edit</button>
          <button className="bg-danger text-white text-sm px-4 py-2 rounded-md hover:opacity-90">Delete</button>
          <button className="bg-primary text-white text-sm px-4 py-2 rounded-md hover:opacity-90">Mark as Paid</button>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-panel-dark p-6 rounded-md space-y-8">
        ...
        <div className="bg-panel-darker rounded-md overflow-hidden">
          ...
          {/* Total Footer */}
          <div className="bg-panel-dark px-6 py-4 flex justify-between items-center">
